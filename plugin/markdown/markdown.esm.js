...
if (
  ...
  Lr(
    ...
    !tu ||
      ...
      Vr(function () {
        return (
          (eu[Xr] = !1), Wr(Qr) != Qr || Wr(eu) == eu || "/a/i" != Wr(Qr, "i")
        );
      }),
  )
) {
      ...
      [
        ...
        function (e, u) {
          ...
          for (var h = 0, D = 0, g = []; D < a.length; ) {
            ...
            if (
              null === v ||
              (d = Yu(qu(f.lastIndex + (Hu ? D : 0)), a.length)) === h
            )
              D = Uu(a, D, s);
            else {
...
var Ku = x,
  ...
  Qu = function (e) {
    return function (t) {
      var n = String(Ku(t));
      return (
        1 & e && (n = n.replace(Wu, "")), 2 & e && (n = n.replace(Ju, "")), n
      );
    };
  },
        ...
        : yo.addEventListener &&
          ...
          : (po =
              "onreadystatechange" in Fo("script")
                ? function (e) {
                    ko.appendChild(Fo("script")).onreadystatechange =
                      function () {
...
var ca,
    ...
    if (p) r = e;
      ...
      if (no(u)) {
        for (i = 0, o = ro(e.length); o > i; i++)
          if ((a = d(e[i])) && a instanceof ao) return a;
        return new ao(!1);
      }
      r = u.call(e);
    }
  ...
  vl = function (e, t, n) {
    e.done ||
      ((e.done = !0), n && (e = n), (e.value = t), (e.state = 2), fl(e, !0));
  },
  Al = function (e, t, n) {
    if (!e.done) {
      (e.done = !0), n && (e = n);
  ...
  { target: "Array", proto: !0, forced: !Il },
  {
    slice: function (e, t) {
      ...
      if (
        ...
        return $l.call(i, a, l);
      for (
        r = new (void 0 === n ? Array : n)(Pl(l - a, 0)), u = 0;
        a < l;
        a++, u++
      )
        a in i && Rl(r, u, i[a]);
...
var Ll,
  ...
  Hl = g
    ...
    : function (e, t) {
        Zl(e);
        for (var n, r = Gl(t), u = r.length, i = 0; u > i; )
          ql.f(e, (n = r[i++]), t[n]);
        return e;
      },
  Vl = ee,
...
[].keys &&
  ("next" in (cs = [].keys())
    ? (ss = Es(Es(cs))) !== Object.prototype && (ls = ss)
    : (bs = !0)),
  (null == ls ||
    ys(function () {
      var e = {};
...
var Cs = { IteratorPrototype: ls, BUGGY_SAFARI_ITERATORS: bs },
  ...
  Rs = function (e, t, n) {
    var r = t + " Iterator";
    return (
      (e.prototype = ws(xs, { next: Bs(1, n) })), Ss(e, r, !1), (_s[r] = Ts), e
    );
  },
  js = As,
  Is = Cr,
    ...
    if (
      (d &&
        ...
        Ms !== Object.prototype &&
          a.next &&
          (js(a) !== Ms &&
            (Is ? Is(a, Ms) : "function" != typeof a[Us] && $s(a, Us, qs)),
          zs(a, f, !0))),
      "values" == u &&
        D &&
        "values" !== D.name &&
                ...
                if (
                  ...
                  this.options.pedantic ||
                    ((c = n.match(
                      ...
                      ((o =
                        n.length - c.index + g.slice(A + 1).join("\n").length),
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            if ((n = this.rules.inline.url.exec(e))) {
              var r, u;
              if ("@" === n[2])
                u = "mailto:" + (r = Rf(this.options.mangle ? t(n[0]) : n[0]));
              else {
                var i;
                do {
                  (i = n[0]),
...
var Xf = (function () {
    function e(n) {
      ...
      this.options.pedantic
        ...
        : this.options.gfm &&
          ((r.block = Gf.gfm),
          this.options.breaks ? (r.inline = Hf.breaks) : (r.inline = Hf.gfm)),
    ...
    return (
      r(e, [
        ...
        },
        {
          ...
          value: function (e, t, n) {
            if (
              null === (e = Jf(this.options.sanitize, this.options.baseUrl, e))
            )
              return n;
            var r = '<a href="' + Qf(e) + '"';
...
function Ep(e, t, n) {
  ...
  try {
    ...
    if (
      ...
      return (
        "<p>An error occurred:</p><pre>" + dp(e.message + "", !0) + "</pre>"
      );
    throw e;
  }
}
(Ep.options = Ep.setOptions =
  ...
  (Ep.parseInline = function (e, t) {
    ...
    try {
      ...
      return (
        t.walkTokens && Ep.walkTokens(n, t.walkTokens), sp.parseInline(n, t)
      );
    } catch (e) {
      if (
        ((e.message +=
...
export default function () {
  ...
  function a(e, t) {
    ...
    return (
      2 === n.length &&
        (e = n[0] + '<aside class="notes">' + mp(n[1].trim()) + "</aside>"),
