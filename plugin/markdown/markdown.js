!(function (e, t) {
    ...
    return [
      ...
      function (e) {
        ...
        for (var a, l = [], s = 0; null !== (a = ku(u, i));) {
          var c = String(a[0]);
          ((l[s] = c),
            "" === c && (u.lastIndex = mu(i, yu(u.lastIndex), o)),
            s++);
        }
        return 0 === s ? null : l;
      },
        ...
        [
          ...
          function (e, u) {
            ...
            for (var h = 0, D = 0, g = []; D < a.length;) {
              ...
              if (
                null === v ||
                (d = Ju(Vu(f.lastIndex + (Xu ? D : 0)), a.length)) === h
              )
                D = Hu(a, D, s);
              else {
  ...
  (Ro && jo) ||
    ...
    To
      ...
      : Io && Io.now
        ...
        : zo && !_o
          ? ((mo = (Eo = new zo()).port2),
            (Eo.port1.onmessage = qo),
            (yo = wo(mo.postMessage, mo, 1)))
          : Co.addEventListener &&
            ...
            : (yo =
                Mo in So("script")
                  ? function (e) {
                      Bo.appendChild(So("script")).onreadystatechange =
                        function () {
  ...
  var va,
    ...
    El = function (e, t, n) {
      ...
      (pl
        ...
        !hl && (u = wa["on" + e])
          ? u(r)
          : e === Dl && Ga("Unhandled promise rejection", n));
    },
    ml = function (e) {
      Ua.call(wa, function () {
        var t,
    ...
    Cl = function (e, t, n) {
      e.done ||
        ((e.done = !0), n && (e = n), (e.value = t), (e.state = 2), yl(e, !0));
    },
    xl = function (e, t, n) {
      if (!e.done) {
        ((e.done = !0), n && (e = n));
  ...
  $l(
    { target: "Array", proto: !0, forced: !ql },
    {
      slice: function (e, t) {
        ...
        for (
          r = new (void 0 === n ? Array : n)(Hl(l - a, 0)), u = 0;
          a < l;
          a++, u++
        )
          a in i && Nl(r, u, i[a]);
  ...
  ([].keys &&
    ("next" in (As = [].keys())
      ? (vs = Bs(Bs(As))) !== Object.prototype && (ds = vs)
      : (Os = !0)),
    (null == ds ||
      ws(function () {
        var e = {};
      ...
      if (
        (d &&
          ...
          Ys !== Object.prototype &&
            a.next &&
            (Us(a) !== Ys &&
              (qs ? qs(a, Ys) : "function" != typeof a[Xs] && Gs(a, Xs, ec)),
            Zs(a, f, !0))),
        u == Js &&
          D &&
          D.name !== Js &&
    ...
    { target: "Array", proto: !0, forced: !pf },
    {
      splice: function (e, t) {
        ...
        if (((u.length = r), n < r)) {
          ...
          for (i = s - r; i > c; i--)
            ((a = i + n - 1),
              (o = i + r - 1) in l ? (l[a] = l[o]) : delete l[a]);
              ...
              if (u)
                return (
                  (r =
                    "@" === u[2]
                      ? "mailto:" +
                        (n = Xf(this.options.mangle ? t(u[1]) : u[1]))
                      : (n = Xf(u[1]))),
                  {
                    type: "link",
                    raw: u[0],
          ...
          },
          {
            ...
            value: function (e, t) {
              ...
              if ((n = this.rules.inline.url.exec(e))) {
                ...
                if ("@" === n[2])
                  u =
                    "mailto:" + (r = Xf(this.options.mangle ? t(n[0]) : n[0]));
                else {
                  var i;
                  do {
                    ((i = n[0]),
  ...
  ((rp.def = tp(rp.def)
    .replace("label", rp._label)
    .replace("title", rp._title)
    .getRegex()),
    (rp.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (rp.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
    ...
    (rp.paragraph = tp(rp._paragraph)
      ...
      .replace("tag", rp._tag)
      .getRegex()),
    (rp.blockquote = tp(rp.blockquote)
      .replace("paragraph", rp.paragraph)
      .getRegex()),
    (rp.normal = np({}, rp)),
    (rp.gfm = np({}, rp.normal, {
      nptable:
  ...
  ((up.punctuation = tp(up.punctuation)
    ...
    (up.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (up.escapedEmSt = /\\\*|\\_/g),
    (up._comment = tp(rp._comment)
      .replace("(?:--\x3e|$)", "--\x3e")
      .getRegex()),
    (up.emStrong.lDelim = tp(up.emStrong.lDelim)
    ...
    (up.gfm.url = tp(up.gfm.url, "i")
      .replace("email", up.gfm._extended_email)
      .getRegex()),
    (up.breaks = np({}, up.gfm, {
                  ...
                  switch ((o = e[t]).type) {
                    ...
                    case "table":
                      ...
                      for (u = o.cells.length, n = 0; n < u; n++)
                        for (
                          i = o.cells[n], o.tokens.cells[n] = [], r = 0;
                          r < i.length;
                          r++
                        )
                          ((o.tokens.cells[n][r] = []),
                            this.inlineTokens(i[r], o.tokens.cells[n][r]));
                      break;
                    case "blockquote":
              ...
              value: function (e) {
                ...
                for (; e;)
                  if ((u || (i = ""), (u = !1), (t = this.tokenizer.escape(e))))
                    ...
                    ((e = e.substring(t.raw.length)),
                      "link" === t.type &&
                        (t.tokens = this.inlineTokens(t.text, [], !0, l)),
                      o.push(t));
        ...
        r(e, [
          ...
          },
          {
            ...
            value: function (e, t, n) {
              if (
                null ===
                (e = gp(this.options.sanitize, this.options.baseUrl, e))
              )
                return n;
              var r = '<a href="' + dp(e) + '"';
              return (
                  ...
                  switch ((c = e[t]).type) {
                    ...
                    case "table":
                      ...
                      for (
                        ...
                        for (
                          a = "", i = (o = c.tokens.cells[n]).length, r = 0;
                          r < i;
                          r++
                        )
  ...
  function Ip(e, t, n) {
    ...
    try {
      ...
      if (
        ...
        return (
          "<p>An error occurred:</p><pre>" + Rp(e.message + "", !0) + "</pre>"
        );
      throw e;
    }
  }
  ((Ip.options = Ip.setOptions =
    ...
    (Ip.parseInline = function (e, t) {
      ...
      try {
        ...
        return (
          t.walkTokens && Ip.walkTokens(n, t.walkTokens),
          xp.parseInline(n, t)
        );
      } catch (e) {
        if (
  ...
  return function () {
    ...
    function a(e, t) {
      ...
      return (
        2 === n.length &&
          (e = n[0] + '<aside class="notes">' + Pp(n[1].trim()) + "</aside>"),
        '<script type="text/template">' +
          (e = e.replace(/<\/script>/g, Lp)) +
          "</script>"
      );
    }
    function l(e, t) {
