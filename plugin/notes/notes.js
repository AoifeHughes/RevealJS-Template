!(function (t, e) {
  ...
  (Q.exports = function (t, e, n, r) {
    ...
    ("function" == typeof n &&
      ...
      (u = Jt(n)).source ||
        (u.source = Ht.join("string" == typeof e ? e : ""))),
      t !== Mt
  ...
  Un("search", 1, function (t, e, n) {
    return [
      ...
      function (t) {
        ...
        var o = Vn(u, i);
        return (
          Yn(u.lastIndex, a) || (u.lastIndex = a),
          null === o ? -1 : o.index
        );
      },
    ];
    ...
    { target: "Array", proto: !0, forced: !$a },
    {
      splice: function (t, e) {
        ...
        if (((u.length = r), n < r)) {
          ...
          for (i = s - r; i > c; i--)
            ((o = i + n - 1),
              (a = i + r - 1) in l ? (l[o] = l[a]) : delete l[o]);
              ...
              if (u)
                return (
                  (r =
                    "@" === u[2]
                      ? "mailto:" +
                        (n = ko(this.options.mangle ? e(u[1]) : u[1]))
                      : (n = ko(u[1]))),
                  {
                    type: "link",
                    raw: u[0],
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if ((n = this.rules.inline.url.exec(t))) {
                ...
                if ("@" === n[2])
                  u =
                    "mailto:" + (r = ko(this.options.mangle ? e(n[0]) : n[0]));
                else {
                  var i;
                  do {
                    ((i = n[0]),
        ...
        sr(t, [
          ...
          },
          {
            ...
            value: function (t, e, n) {
              if (
                null ===
                (t = jo(this.options.sanitize, this.options.baseUrl, t))
              )
                return n;
              var r = '<a href="' + Mo(t) + '"';
              return (
  ...
  function ol(t, e, n) {
    ...
    try {
      ...
      if (
        ...
        return (
          "<p>An error occurred:</p><pre>" + rl(t.message + "", !0) + "</pre>"
        );
      throw t;
    }
  }
  ((ol.options = ol.setOptions =
    ...
    (ol.parseInline = function (t, e) {
      ...
      try {
        ...
        return (
          e.walkTokens && ol.walkTokens(n, e.walkTokens),
          Vo.parseInline(n, e)
        );
      } catch (t) {
        if (
